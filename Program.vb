...
Module Module1
     ...
     Console.Write(Environment.NewLine & "   ")
            ...
            For Row = 1 To NoOfRows
                ...
                For Column = 1 To NoOfColumns 'spaces
                    ...
                    If Board(SquareReference).GetPieceInSquare().GetBelongsTo().CheckPlayerMove(pos, SquareReference, Row * 10 + Column)
                        Console.write("^")
                    End if
                Next
                Console.WriteLine("|")
        ...
        Public Sub PlayGame()
            ...
            While Not GameOver
                ...
                DisplayBoardWithMoveOptions(StartSquareReference, CurrentPlayer.getMoveOptionInPos(Choice))
                '------------------------------------------
    ...
    Class Player
        ...
        Function  getMoveOptionInPos(byval pos As Integer)  As MoveOption
